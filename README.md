...
4. [Referencia de módulos](#4-referencia-de-módulos)
   ...
   6. [`src/web/` — interfaz web](#46-srcweb--interfaz-web)
   7. [`native/kat_entropy.c` — wrapper LD_PRELOAD](#47-nativekat_entropyc--wrapper-ld_preload)
   8. [Harnesses nativos por librería](#48-harnesses-nativos-por-librería)
   9. [`native/CMakeLists.txt` y scripts de build](#49-nativecmakeliststxt-y-scripts-de-build)
